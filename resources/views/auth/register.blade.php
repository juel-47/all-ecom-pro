    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 sm:p-12">
        ...
        <div class="w-full max-w-md glass-card rounded-[2.5rem] p-10 relative overflow-hidden">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-bold text-white mb-2">Join Denmark's Finest</h2>
                <p class="text-slate-500 text-sm font-medium">Create your shopper account today</p>
            </div>

            <form method="POST" action="{{ route('register') }}" class="space-y-7 relative z-10">
                @csrf

                <!-- Name -->
                <div class="space-y-3">
                    <label for="name" class="text-xs font-bold uppercase tracking-[0.15em] text-slate-500 ml-1">Full Name</label>
                ...
                <!-- Password -->
                <div class="space-y-3">
                    <label for="password" class="text-xs font-bold uppercase tracking-[0.15em] text-slate-500 ml-1">Secure Password</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-500 group-focus-within:text-indigo-400 transition-colors">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-12 text-center pt-8 border-t border-slate-800/50">
                    <p class="text-slate-600 text-xs font-bold uppercase tracking-widest">
                        ...
                        <a href="{{ route('login') }}" class="text-indigo-400 hover:text-indigo-300 ml-2">Sign In</a>
                    </p>
                </div>
            </form>
        </div>
